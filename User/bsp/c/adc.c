...
/* Private typedef -----------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
static volatile float volt_vrefint_proportion = 8.0586080586080586080586080586081e-4f;
...
float BSP_GetBatteryVolt(void) {
	...
	float volt = (float)raw * volt_vrefint_proportion * 10.090909090909090909090909090909f;
