...
static const Config_PilotCfg_t cfg_qs = {
  .param = {
		...
		.sens_rc = 6.0f,
    .map = {
      .key_map[CMD_BEHAVIOR_FORE] = CMD_KEY_W,
      .key_map[CMD_BEHAVIOR_BACK] = CMD_KEY_S,
      .key_map[CMD_BEHAVIOR_LEFT] = CMD_KEY_A,
      .key_map[CMD_BEHAVIOR_RIGHT] = CMD_KEY_D,
      .key_map[CMD_BEHAVIOR_ACCELERATE] = CMD_KEY_SHIFT,
      .key_map[CMD_BEHAVIOR_DECELEBRATE] = CMD_KEY_CTRL,
      .key_map[CMD_BEHAVIOR_FIRE] = CMD_L_CLICK,
      .key_map[CMD_BEHAVIOR_FIRE_MODE] = CMD_R_CLICK,
      .key_map[CMD_BEHAVIOR_FOLLOWGIMBAL35] = CMD_KEY_E,
      .key_map[CMD_BEHAVIOR_OPENCOVER] =  CMD_KEY_F,
      .key_map[CMD_BEHAVIOR_REVTRIG] = CMD_KEY_R,
      .key_map[CMD_BEHAVIOR_ROTOR] = CMD_KEY_G,
    },
    .move = {
      .move_sense = 0.8f,
