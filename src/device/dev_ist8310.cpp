...
static void ist8310_mem_rx_cplt_callback(void *arg) {
  ...
  ist8310_t *ist8310 = (ist8310_t *)arg;
...
static void ist8310_int_callback(void *arg) {
  BaseType_t switch_required;
  ist8310_t *ist8310 = (ist8310_t *)arg;
  xSemaphoreGiveFromISR(ist8310->sem._new, &switch_required);
  portYIELD_FROM_ISR(switch_required);
}
...
bool ist8310_wait_new(ist8310_t *ist8310, uint32_t timeout) {
  return xSemaphoreTake(ist8310->sem._new, pdMS_TO_TICKS(timeout)) == pdTRUE;
}
