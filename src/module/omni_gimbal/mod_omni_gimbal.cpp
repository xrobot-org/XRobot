...
template <typename YawMotor, typename YawMotorParam, typename PitchMotor,
          typename PitchMotorParam>
DMGimbal<YawMotor, YawMotorParam, PitchMotor, PitchMotorParam>::DMGimbal(
    Param& param, float control_freq)
    : param_(param),
      st_(param.st),
      ...
      ctrl_lock_(true) {
  auto event_callback = [](GimbalEvent event, DMGimbal* gimbal) {
  ...
  Component::CMD::RegisterEvent<DMGimbal*, GimbalEvent>(event_callback, this,
...
template <typename YawMotor, typename YawMotorParam, typename PitchMotor,
          typename PitchMotorParam>
void DMGimbal<YawMotor, YawMotorParam, PitchMotor,
              PitchMotorParam>::UpdateFeedback() {
  ...
  switch (this->mode_) {
    ...
    case ABSOLUTE:
      ...
      this->raw_angles_ = this->pit_motor_.GetAngle();
      break;
  }
}
...
template <typename YawMotor, typename YawMotorParam, typename PitchMotor,
          typename PitchMotorParam>
void DMGimbal<YawMotor, YawMotorParam, PitchMotor, PitchMotorParam>::Control() {
  ...
  switch (this->mode_) {
    ...
    case ABSOLUTE:
      ...
      this->pit_motor_.SetMit(pit_out);
...
template <typename YawMotor, typename YawMotorParam, typename PitchMotor,
          typename PitchMotorParam>
void DMGimbal<YawMotor, YawMotorParam, PitchMotor, PitchMotorParam>::SetMode(
    Mode mode) {
  if (mode == this->mode_) {
    return;
  }
...
template <typename YawMotor, typename YawMotorParam, typename PitchMotor,
          typename PitchMotorParam>
void DMGimbal<YawMotor, YawMotorParam, PitchMotor,
              PitchMotorParam>::DrawUIStatic(DMGimbal* gimbal) {
...
template <typename YawMotor, typename YawMotorParam, typename PitchMotor,
          typename PitchMotorParam>
void DMGimbal<YawMotor, YawMotorParam, PitchMotor,
              PitchMotorParam>::DrawUIDynamic(DMGimbal* gimbal) {
  float box_pos_left = 0.0f, box_pos_right = 0.0f;
...
template class Module::DMGimbal<Device::RMMotor, Device::RMMotor::Param,
                                Device::MitMotor, Device::MitMotor::Param>;
