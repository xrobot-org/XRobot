...
class DMGimbal {
 public:
  ...
  DMGimbal(Param &param, float control_freq);
  ...
  static void DrawUIStatic(DMGimbal *gimbal);
 ...
 private:
  ...
  DMGimbal::Mode mode_ = RELAX; /* 云台模式 */
...
typedef DMGimbal<Device::RMMotor, Device::RMMotor::Param, Device::MitMotor,
