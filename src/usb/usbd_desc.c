 ...
 *method. This should be copied to the user folder, renamed and
...
#define USBD_VID 0xFFFC
#define USBD_LANGID_STRING 1033
#define USBD_MANUFACTURER_STRING "QDU RM"
#define USBD_PID_FS 8888
#define USBD_PRODUCT_STRING_FS "MCU CLI"
