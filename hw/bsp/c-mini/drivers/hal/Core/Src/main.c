...
void MX_GPIO_Init(void) {
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GYRO_CS_Pin | LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GYRO_CS_Pin LED_Pin */
  GPIO_InitStruct.Pin = GYRO_CS_Pin | LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : ACCL_INT_Pin */
  GPIO_InitStruct.Pin = ACCL_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ACCL_INT_GPIO_Port, &GPIO_InitStruct);
